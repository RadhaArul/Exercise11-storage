...
namespace Storage.Controllers
{
    public class ProductsController : Controller
    {
       ...
       //  GET: Products
        ...
        //Exercise 11 Display selected Fields
         public async Task<IActionResult> PVMIndex()
        {
        ...
        // Exercise 11 Display by Category

        public async Task<IActionResult> Search(string cat)
        {
            

            var product = _context.Product
                .Where(p => p.Category.StartsWith(cat))
